      ...
      {showLogin ? (
        <div>
          <form onSubmit={login} className="grid sm:grid-cols-5 mb-6" noValidate>
            <h1 className="sm:col-start-2 sm:col-end-5 mb-6 font-bold text-5xl">
              {"Anmelden"}
            </h1>
            <div className="sm:col-start-2 sm:col-end-5 mb-6">
              <Input key="login-email" name="login-email" label="Email" type="email" required={true} pattern={"[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$"} />
              <Input key="login-password" name="login-password" label="Password" type="password" required={true} pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$" />
            </div>
        ...
        <div>
          <form onSubmit={register} className="grid sm:grid-cols-5 mb-6" noValidate>
            ...
            <div className="sm:col-start-2 sm:col-end-5 mb-6">
              ...
              <Input key="register-email" name="register-email" label="Email" type="email" required={true} pattern="[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" />
              <Input key="register-password" name="register-password" label="Password" type="password" required={true} pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$" />
            </div>
            <div className="sm:col-start-2 sm:col-end-5">
              <Button
                id="login-button"
