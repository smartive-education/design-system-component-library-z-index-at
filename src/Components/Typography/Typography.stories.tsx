...
const Template: ComponentStory<typeof Typography> = (args) => (
  <div>
    <Typography type="h1">Headline H1</Typography>
    <br />
    <Typography type="h2">Headline H2</Typography>
    <br />
    <Typography type="h3">Headline H3</Typography>
    <br />
    <Typography type="h4">Headline H4</Typography>
    <br />
    <Typography type="paragraph-l">
    ...
    <br />
    <Typography type="label-xl">Label XL</Typography>
    <br />
    <br />
    <Typography type="label-l">Label L</Typography>
    <br />
    <br />
    <Typography type="label-m">Label M</Typography>
    <br />
    <br />
    <Typography type="placeholder">Placeholder</Typography>
    <br />
    <Typography type="label-s">Label S</Typography>
    <br />
  </div>
);
